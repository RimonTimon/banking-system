...
ALLOWED_HOSTS = ['localhost', '127.0.0.1']  # You can add domain here later
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'mdrimon01889@gmail.com'
EMAIL_HOST_PASSWORD = 'hfqm kjhq lbem dial'  # 🔐 Consider moving this to an environment variable
